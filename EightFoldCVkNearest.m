...
%   labelled:   If the test data comes with a lables file in the testParh this should be 1, otherwise 0
%   
%
function [trainProps, trainLabs] = EightFoldCV(trainPath, testPath, labelled, backnum, splitType, mhiType, likeType, show,nearestHack)
	...
	for fold = 1:8
        ...
        rockDists = inf(dimTest(1),1);
        paperDists = inf(dimTest(1),1);
        scissorsDists = inf(dimTest(1),1);
